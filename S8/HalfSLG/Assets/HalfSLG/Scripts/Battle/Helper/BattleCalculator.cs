...
namespace ELGame
{
        ...
        :NormalSingleton<BattleCalculator>, IGameBase
    {
        ...
        //自动释放分析器
        private BattleSkillAutoReleaseAnalysisor autoReleaseAnalysisor;
        //技能被释放的影响结果
        ...
        public BattleSkillAutoReleaseAnalysisor AutoReleaseAnalysisor
        {
            get
            {
                return autoReleaseAnalysisor;
            }
        }
