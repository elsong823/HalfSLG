...
namespace ELGame
{
          ...
          IVisualRenderer<BattleField, BattleFieldRenderer>
    {
...
#if UNITY_EDITOR
        public BattleUnit editor_ManualOptBattleUnit;
#endif
        ...
        public void Init()
        {
            ...
            //战场显示器初始化完成，通知回调
            EventManager.Instance.Run(EGameConstL.Event_BattleFieldRendererReady, null);
        }
...
#if UNITY_EDITOR
            editor_ManualOptBattleUnit = operatingBattleUnit.battleUnit;
#endif
        }
