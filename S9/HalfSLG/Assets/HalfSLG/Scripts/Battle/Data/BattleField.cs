...
namespace ELGame
{
        ...
        : CountableInstance, IVisualData<BattleField, BattleFieldRenderer>
    {
        ...
        public List<BattleAction> battleActions = new List<BattleAction>(BATTLE_ACTIONS_DEFAULT_CAPACITY); //战斗行动信息
        ...
        public void AppendBattleActions(List<BattleAction> actions)
        {
            ...
            {
                actions[i].sn = battleActions.Count + i;
            }
        ...
        public void ConnectRenderer(BattleFieldRenderer renderer)
        {
            ...
            //连接了渲染器的需要注册一个消息的监听
            EventManager.Instance.Register(EGameConstL.EVENT_MANUAL_OPERATION_COMPLETE, this, ManualOperationComplete);
