...
namespace ELGame
{
    public class EGameConstL
    {
        ...
        //事件：战场渲染器准备完毕
        public const string Event_BattleFieldRendererReady = "Event_BattleFieldRendererReady";
        public const string EVENT_MANUAL_OPERATION_COMPLETE = "EVENT_MANUAL_OPERATION_COMPLETE";
    }
}